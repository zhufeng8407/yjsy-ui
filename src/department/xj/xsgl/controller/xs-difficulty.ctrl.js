(function () {
    ...
    XsDifficultyCtrl.$inject = ['$scope', 'PathUtils', 'ecnuDiffDao', 'ecnuGlobalDao', 'FileExport'];
    function XsDifficultyCtrl($scope, PathUtils, ecnuDiffDao, ecnuGlobalDao, FileExport) {
        var vm = this;
        vm.currentPage = 1;
        vm.numPerPage = 10;
        vm.maxSize = 5;
        ...
        vm.downloadPath = PathUtils.qualifiedPath("/download/助困.xlsx");
        vm.uploading = false;
        vm.flag = false;
        vm.exportBtn = true;
