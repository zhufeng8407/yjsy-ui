...
(function () {
    ...
    DsImportCtrl.$inject = ['$scope', 'Upload', '$timeout', 'PathUtils', 'ecnuStaffDao'];
    function DsImportCtrl($scope, Upload, $timeout, PathUtils, ecnuStaffDao) {
        var vm = this;
        var url = PathUtils.qualifiedAPIPath("xj/dsImport/");

        vm.downloadPath = PathUtils.qualifiedPath("/download/导师.xlsx");
        vm.uploading = false;
        vm.flag = false;
        vm.exportBtn = false;
        vm.tag = "staffError";
