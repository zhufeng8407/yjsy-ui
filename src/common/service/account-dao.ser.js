 ...
 * 当前服务主要负责处理帐号相关的查询处理，包括帐号的创建，登录注销，角色的关联等。
 */
(function () {
    'use strict';
    ...
    function accountDao(conn, QUERY_PARAMS) {
        ...
        vm.findStaffByUsername = findStaffByUsername;
        ...
        function findStaffByUsername(username,callback){
            var param = {};
            param['username'] = username;
            conn.get(BASE_URL + "/staff",param,callback);
        }
    }
})();