...
(function () {
    ...
    utils.service("PageState",
                  ['$cookies', '$window', 'PathUtils', 'ecnuAccountDao', 'PAGE_TYPE', 'ENDPOINTS', PageState]);
    function PageState($cookies, $window, pathUtils, ecnuAccountDao, PAGE_TYPE, ENDPOINTS) {
        var vm = this;
        ...
        vm.validatePageType = validatePageType;
        ...
        function validatePageType(curType) {
            if (!curType.hasOwnProperty(vm.getCurPageType())) {
                return true;
            }
        }
        ...
        function getPageTypeOfRole(curRole) {
            if (curRole.isUniv) {
                return PAGE_TYPE.UNIVERSITY;
            } else if (curRole.studentID) {
                return PAGE_TYPE.STUDENT;
            } else if (curRole.facultyID) {
                return PAGE_TYPE.TEACHER;
            } else if (curRole.department) {
                return PAGE_TYPE.DEPARTMENT;
            } else if (curRole.school) {
                return PAGE_TYPE.SCHOOL;
            }
        }
