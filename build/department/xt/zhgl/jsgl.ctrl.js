...
(function () {
    ...
    ecnuAdminHome.controller('RoleCtrl', ['ecnuRoleDao', 'ecnuMenuDao', 'SERVICE_API_ROOT', '$uibModal', RoleCtrl]);
    function RoleCtrl(ecnuRoleDao, ecnuMenuDao, SERVICE_API_ROOT, $uibModal) {
        var vm = this;
        var ids = new Array();
        var roleid = -1;
