...
(function () {
    ...
    function ecnuMetaDataDao(conn, QUERY_PARAMS) {
        ...
        vm.getUniversityIdName = getUniversityIdName;
        ...
        // vm.getExamineeOriginByPage = getExamineeOriginByPage;
        // vm.getFeeSystemByPage = getFeeSystemByPage;
        // vm.getGraduateTypeByPage = getGraduateTypeByPage;
        ...
        //大毕院校id和name
        function getUniversityIdName(bachelorUnitName, callback) {
            conn.get(BASE_URL + "universityIdName", {'bachelorUnitName': bachelorUnitName}, callback);
        }
        ...
        function getUnitDepartment(schoolCode, callback) {
            var param = {};
            param[QUERY_PARAMS.SCHOOL_CODE] = schoolCode;
            conn.get(BASE_URL + 'unit-department', param, callback);
        }
