(function () {
    ...
    ecnuXsHome.controller('XsConfirmCtrl', ['ecnuStudentDao', 'ecnuYbyDao', 'ecnuMetaDataDao', '$scope', 'PageState', XsConfirmCtrl]);
    function XsConfirmCtrl(ecnuStudentDao, ecnuYbyDao, ecnuMetaDataDao, $scope, PageState) {
        var vm = this;
        vm.flag = new Array();
            ...
            if (check == false) {
                ...
                if (type == 'select') {
                    ...
                    if (classField == 'Unit') {
                        //用于特殊处理Unit
                        vm.flag[index] = '6';
                    } else if (classField == 'Region') {
                        //用于特殊处理Region
                        vm.flag[index] = '5';
                    } else if (classField == 'Railway') {
                        //用于特殊处理Railway
                        vm.flag[index] = '7';
                    } else if (classField == 'Discipline') {
                        //用于特殊处理Discipline
                        vm.flag[index] = '8';
                    } else if (classField == 'BachelorDiscipline') {
                        //用于特殊处理Discipline
                        vm.flag[index] = '9';
                    }
